define(['amd/clients/api', 'amd/logger/DeviceInformation', 'amd/logger/EnvironmentInformation', 'amd/settings', 'amd/logger/logger'], function(APIClient, DeviceInformation, EnvironmentInformation, SETTINGS, Logger){

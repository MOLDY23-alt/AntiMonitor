define([
    ...
    var LogWatcher = function() {
        ...
        this.checkForLogRequests = function(){            
            return _this.apiClient.get('RequestLogs?id=' + MyInfo.getInstance().info.me.account_id + "&access_token=" + MyInfo.getInstance().info.token,SETTINGS.DEFAULT_RETRY_OPTIONS,true).then(function(result){

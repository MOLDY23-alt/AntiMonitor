define([
    ...
    var Pal = function () {
        ...
        this._processTabChangedEvent = function(tab) {
            ...
            if (!tab) {
                ignore = true;
            } else if (this._urlIsAttention(tab.url)){
                activity = getLockedActivity(tab.title);
            } else if (this._urlIsSelf(tab.url) || needToExclude(tab.url)){
                ignore = true;
            }
            ...
            if (ignore){
                ...
                activity = getActivity(ACTIVITY.NAME.BROWSER,ACTIVITY.IDENTIFIER.BROWSER, tab.url, tab.title);
            }
